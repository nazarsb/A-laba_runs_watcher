...
class Event(Base):
    ...
    event_start_date: Mapped[str] = mapped_column(String(255), nullable=False)
    event_end_date: Mapped[str] = mapped_column(String(255), nullable=False)
    time_start: Mapped[str | None] = mapped_column(String(255))
    time_end: Mapped[str | None] = mapped_column(String(255))
